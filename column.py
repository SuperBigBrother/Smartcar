...
def gotopos():
    vLeft_0 = 1;
    vright_0 = 1;
    if((abs(car0_pos[0] - car1_pos[0]) > 0.01) or (abs(car0_pos[1] - car1_pos[1]) > 0.01) or (abs(car1_pos[0] - car2_pos[0]) > 0.01) or (abs(car1_pos[1] - car2_pos[1]) > 0.01)):
        if((abs(car0_pos[0] - car1_pos[0]) > 0.01) or (abs(car0_pos[1] - car1_pos[1]) > 0.01)):
            vLeft_1 = 1*(car0_pos[0] - car1_pos[0]) - 0.2*(car0_pos[1] - car1_pos[1])
            vright_1 = 1*(car0_pos[0] - car1_pos[0]) + 0.2*(car0_pos[1] - car1_pos[1])
            if(abs(car0_pos[1] - car1_pos[1]) < 0.01):
                if(abs(car0_dir[2] - car1_dir[2]) > 0.001):
                    vLeft_1 = -5*(car0_dir[2] - car1_dir[2]) + 0*(car0_pos[0] - car1_pos[0])
                    vright_1 = 5*(car0_dir[2] - car1_dir[2]) + 0*(car0_pos[0] - car1_pos[0])
                else:
                    vLeft_1 = 1*(car0_pos[0] - car1_pos[0])
                    vright_1 = 1*(car0_pos[0] - car1_pos[0])
        else:
            vLeft_1 = 0;
            vright_1 = 0;
        if((abs(car1_pos[0] - car2_pos[0]) > 0.01) or (abs(car1_pos[1] - car2_pos[1]) > 0.01)):
            vLeft_2 = 1*(car1_pos[0] - car2_pos[0]) - 0.2*(car1_pos[1] - car2_pos[1])
            vright_2 = 1*(car1_pos[0] - car2_pos[0]) + 0.2*(car1_pos[1] - car2_pos[1])
            if(abs(car1_pos[1] - car2_pos[1]) < 0.01):
                if(abs(car1_dir[2] - car2_dir[2]) > 0.001):
                    vLeft_2 = -5*(car1_dir[2] - car2_dir[2]) + 0*(car1_pos[0] - car2_pos[0])
                    vright_2 = 5*(car1_dir[2] - car2_dir[2]) + 0*(car1_pos[0] - car2_pos[0])
                else:
                    vLeft_2 = 1*(car1_pos[0] - car2_pos[0])
                    vright_2 = 1*(car1_pos[0] - car2_pos[0])
        else:
            vLeft_2 = 0;
            vright_2 = 0;
